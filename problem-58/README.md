...
Given a list of boxes with width and height, find the maximum number that can be nested — a box fits inside another only if both its width and height are strictly smaller.
