...
Given city locations as 2D coordinates, find the minimum total cable needed to connect every city. Cable cost between two cities is their Manhattan distance.
