...
Given a list of tasks (some repeated) and a cooldown n, find the minimum time to execute all tasks with at least n time units between any two identical tasks.
