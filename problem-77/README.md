...
Design a fixed-capacity cache that evicts the least frequently accessed item when full. Ties in frequency are broken by recency — the least recently used item is evicted first. Both get and put must run in O(1).
