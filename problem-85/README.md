...
Given a road network with travel costs, find the city that can reach the fewest other cities within a given distance budget. If there is a tie, return the city with the highest index.
