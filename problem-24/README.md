...
Given a list of positive integers and a target value, find all unique combinations of numbers that sum exactly to the target. Each number may be used multiple times.
