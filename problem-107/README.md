...
Given a list of intervals and a list of query points, for each query find the length of the smallest interval that contains it. Return -1 for queries no interval covers.
