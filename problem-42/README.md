...
Given a list of words and a target line width, format the words into fully justified lines with spaces distributed as evenly as possible. The last line is left-aligned.
