...
Given a sorted list of allowed digit characters and an upper bound n, count how many positive integers ≤ n can be formed using only the allowed digits (with repetition).
