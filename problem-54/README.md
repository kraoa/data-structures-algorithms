...
In a grid game, any region of 'O' cells completely surrounded by 'X' cells on all sides (not touching the border) is captured and converted to 'X'. Apply this rule in-place.
