...
Given a string of digits and a target integer, insert +, -, or * between the digits to form expressions that evaluate to the target. Return all valid expressions.
