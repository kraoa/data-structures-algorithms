...
Build a data structure over an array that answers range-minimum queries — what is the smallest value between index l and r? — in O(1) per query after preprocessing.
