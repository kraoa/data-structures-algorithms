...
Driving from start to destination, you begin with a full tank. Fuel stops along the route add variable amounts. Find the minimum number of stops needed to reach the destination.
