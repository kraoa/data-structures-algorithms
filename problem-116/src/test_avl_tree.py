"""Tests for the avl_tree driver. Must pass out of the box."""
...
class SortedListTree:
    """Reference using a sorted Python list — O(n log n) inorder, O(n) insert/search."""
...
class TestAVLTreeDriver(unittest.TestCase):
