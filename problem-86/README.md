...
# Recursive Data Stream

Design an iterator that accepts a nested list structure (where each element is either an integer or another nested list) and yields all integers one at a time in order.
