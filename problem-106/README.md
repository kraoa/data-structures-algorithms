...
Given a list of tasks each with a duration and a deadline, find the maximum number of tasks that can be completed on time if you can only work on one task at a time.
