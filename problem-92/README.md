...
Given a binary tree where each node holds a value, collect values from nodes such that no two directly connected nodes (parent and child) are both collected. Maximize the total collected.
