...
Given a network of people where each edge means two people cannot be on the same team, determine whether everyone can be assigned to one of two teams with no conflicts.
