...
Split an ordered list of task sizes across k workers (as k contiguous chunks, preserving order) to minimize the maximum load assigned to any single worker.
