...
Implement a pattern matcher where '.' matches any single character and '*' matches zero or more of the preceding character. The pattern must match the entire string.
