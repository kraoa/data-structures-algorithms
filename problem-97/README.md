...
A printer produces a line of characters by printing one character repeatedly across a contiguous range per turn, overwriting whatever was there. Find the minimum number of turns to produce a target string.
