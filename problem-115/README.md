...
Design a stack where pop always returns the element that has been pushed the most times. Ties in frequency are broken by recency — the more recently pushed element is returned first.
