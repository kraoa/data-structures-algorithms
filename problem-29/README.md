...
A row of balloons each has a numeric value. Bursting a balloon scores its value multiplied by its current left and right neighbors' values. Find the maximum total score.
